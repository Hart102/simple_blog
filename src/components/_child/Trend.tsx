...
const Trend = ({ data }: PostType) => {
  return (
    <div className='mx-auto h-[40vh] lg:h-[60vh] relative text-yellow-501 lg:my-14'>
      {/* <img src={data.urlToImage} className="w-full h-full" /> */}
      <div className=" flex absolute top-0 left-0 w-full h-full p-1 cursor-pointer bg-rgba1 lg:p-5">
